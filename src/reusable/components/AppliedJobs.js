...
import JobPostItem from '../../reusable/components/JobPostItem2';
...
const JobApplications = (props) => {
  ...
  const loadAllAppliedJobs = () => {
    ...
    axios({
      ...
      url: `/api/user/applied-jobs/get-all`,
      data: bodyFormData,
    ...
    <>
      ...
      <div style={{ overflowY: 'auto', paddingLeft: 10 }}>
        <div style={{ paddingBottom: 10 }}>
          ...
          <Link to='/dashboard/job-applications'>View all</Link>
        </div>
