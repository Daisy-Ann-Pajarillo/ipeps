...
const JobView = ({ job, onClose, isMobile = false }) => {
  ...
  return (
    <div className={`bg-white dark:bg-gray-900 ${isMobile
      ? 'h-[85vh] w-full'
      ...
      <div className={`${isMobile ? 'pt-12' : ''
        } px-2 sm:px-3 md:px-4 py-2 sm:py-3 border-b border-gray-200 dark:border-gray-700`}>
      ...
      <div className={`p-3 sm:p-4 md:p-6 overflow-y-auto ${isMobile
        ? 'h-[calc(100%-180px)]'
        : 'h-[calc(100%-120px)]'
        }`}>
        {/* Job Details Section */}
