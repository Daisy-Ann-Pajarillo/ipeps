      ...
      <div className="p-3 sm:p-4 md:p-6 overflow-y-auto h-[calc(100%-180px)]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6">
          <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
            ...
            <span className="text-sm sm:text-base">{application.city_municipality}, {application.country}</span>
          </div>
          <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
            <SchoolIcon className="text-gray-400 dark:text-gray-500 w-5 h-5" />
            <span className="text-sm sm:text-base">{application.scholarship_type || "Not specified"}</span>
          </div>
          <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
            <PaymentIcon className="text-gray-400 dark:text-gray-500 w-5 h-5" />
            <span className="text-sm sm:text-base">{application.reward_type || "Not specified"}</span>
          </div>
          <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
            <CalendarTodayIcon className="text-gray-400 dark:text-gray-500 w-5 h-5" />
            <span className="text-sm sm:text-base">Applied: {formatDate(application.applied_at)}</span>
          </div>
        </div>
