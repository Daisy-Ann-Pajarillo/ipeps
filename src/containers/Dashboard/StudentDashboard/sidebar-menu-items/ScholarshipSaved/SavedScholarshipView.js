      ...
      <div className={`p-3 sm:p-4 md:p-6 overflow-y-auto ${
        ...
        <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 text-gray-700 dark:text-gray-300 text-xs sm:text-base">
            ...
            <span>{scholarship.scholarship_type || scholarship.type || "Not specified"}</span>
          </div>
          <div className="flex items-center gap-1.5 sm:gap-2 text-gray-700 dark:text-gray-300 text-xs sm:text-base">
            <PaymentIcon fontSize="small" />
            <span>{scholarship.reward_type || scholarship.amount || "Not specified"}</span>
          </div>
        ...
        {(scholarship.requirements || scholarship.requirements_details) && (
          <>
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2">
              {(scholarship.requirements || scholarship.requirements_details).split(",").map((req, index) => (
                <span
                  key={index}
