  ...
  useEffect(() => {
    const fetchScholarships = async () => {
      try {
        ...
        const scholarshipsArray = response.data.scholarship_postings || [];
                ...
                >
                  <CardContent>
                    ...
                    >
                      ...
                      >
                        {savedScholarships[scholarship.scholarship_id] ? (
        ...
        >
          {selectedScholarship && (
            <ScholarshipView
              ...
              onWithdraw={() =>
                handleWithdrawApplication(selectedScholarship.scholarship_id)
              }
            />
          )}
        </Box>
